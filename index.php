...
<body>
    ...
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" id="head">REQUEST FOR CREATION OF USER ACCOUNT IN EPINET</a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="leftComponent col-md-5">
                <img src="img/ONGC_Logo.svg.png" alt="ONGC Image" class="img-fluid img-logo">
            </div>
            <!-- leftComponent ends -->
