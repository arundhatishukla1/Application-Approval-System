...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="admin.php">REQUEST FOR CREATION OF USER ACCOUNT IN EPINET</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="leave_history.php" style="color:white;">View Request History</a>
            </li>
            <li class="nav-item">
            <button id="logout" onclick="window.location.href='logout.php';">Logout</button> </div>
            </li>
    ...
    <h1>Admin Panel - Employee Request History</h1>
        ...
        <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
                  <thead>
                      <th>#</th>
                      <th>CPF No.</th>
                      <th>Request Application</th>
                      <th>Date</th>
                      <th>Status</th>
                  </thead>
                  <tbody>
                    <!-- loading all request applications of the user -->
                    <?php
                          ...
                          if($leaves){
                            ...
                            if($numrow!=0){
                             ...
                             $cnt++; }
                              ...
                              echo"<tr class='text-center'><td colspan='12'>NO REQUEST HISTORY!</td></tr>";
                            }
                          }
                          else{
