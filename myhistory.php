...
<body>
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="leaveAplicationForm.php">REQUEST FOR CREATION OF USER ACCOUNT IN EPINET</a>
                  ...
                  if($leaves){
                    ...
                    if($numrow!=0){
                     ...
                     $cnt++; }
                      ...
                      echo"<tr class='text-center'><td colspan='12'><b>YOU DON'T HAVE ANY REQUEST HISTORY! PLEASE APPLY TO VIEW YOUR STATUS HERE!</b></td></tr>";
                    }
                  }
                  else{
