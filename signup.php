...
error_reporting(E_ALL);
  ...
  <div class="container">
    ...
    <form method="POST" autocomplete="off">
      ...
      <!--username-->
      <div class="form-floating mb-3">
        <input type="text" class="form-control" name="username" id="username" value="<?php echo $username; ?>"placeholder="CPF No.">
      ...
      <select id="city" name="city">
        ...
        <option>Cambay Asset</option>
        <option>Chennai</option>
        <option>Goa</option>
        <option>Hazira</option>
        <option>Joshpur</option>
      ...
      <select name="Department">
        <option>Research & Planning Unit</option>
        <option>Research Projects</option>
        <option>Field Projects</option>
        <option>Technology Scanning</option>
        <option>Development of New Projects</option>
        <option>Economic Analysis & Feasibility Studies</option>
        <option>Seminar/Symposium</option>
        <option>Other Technical Activities</option>
        <option>Coordination</option>
        <option>IT </option>
        <option>HR</option>
        <option>Finance & Accounts</option>
        <option>Secretariat of Trust</option>
      </select>
      </div>
  ...
  <div>
    <p class="text-center">&copy; <?php echo date("Y"); ?> - Application Approval</p>
    </div>
  </footer>
